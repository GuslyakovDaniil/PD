...
$stmt = $pdo->prepare("SELECT * FROM tests WHERE test_name = 'ЦТ' LIMIT 1 OFFSET :offset");
...
if (!empty($row)) {
    ...
    echo '<input class="correct_answer" style="border-radius: 18px; width: 239px;height: 44px;background: transparent;border: non;" type="text" name="answer" value="">';
    echo '<input class="next" style="width: 156px;height: 61px;border-radius: 20px;background: transparent;border: none;"style="width: 156px;height: 61px;border-radius: 20px;background: transparent;border: non;" type="submit" name="submit_answer" value="">';
    echo '</form>';
    echo '<br>';
} else {
